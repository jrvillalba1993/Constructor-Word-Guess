...
var wordOptions = ["aardvark", "wandering", "succesful", "house", "knot", "show", "saunter", "useless"];
            ...
            .prompt([
                {
                    ...
                    validate: function (input) {
                        if (acceptedKeys.indexOf(input) !== -1 && input.length === 1) {
                            ...
                            console.log("\nNot a valid character.. Please use a single, lowercase letter");
                            return false;
                        }
                    }
                }
                ...
                switch (currentUnguessedCount) {
                    ...
                    default:
                        switch (newWord.guessesRemaining) {
                            case 0:
                                console.log("You've used all your guesses! Try a new word.");
                                newGame();
                                break;
                            default:
...
console.log("Welcome! Choose any lowercase letter A-Z to guess your first word!")
newGame();